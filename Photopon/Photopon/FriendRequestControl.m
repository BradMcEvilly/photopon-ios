...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"FriendRequestCellIdentifier"];
    if (cell == nil) {
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"FriendRequestCellIdentifier"];
