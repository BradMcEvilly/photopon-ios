...
#import "/Users/bradmcevilly/Development/com/photopon/photopon-ios/Photopon/Photopon/Onboarding/Photopon-Bridging-Header.h"
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Photopon",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8Photopon28OnboardingPageViewController")
@interface OnboardingPageViewController : UIPageViewController <UIPageViewControllerDataSource, UIPageViewControllerDelegate, EnjoyPhotoponDelegate, LocationServicesViewControllerDelegate, NumberVerificationDelegate, PushNotificationsDelegate>
@property (nonatomic, copy) NSArray<UIViewController *> * _Nonnull pages;
@property (nonatomic) BOOL didViewAlreadyAppear;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC8Photopon15PPRoundedButton")
@interface PPRoundedButton : UIButton
- (void)awakeFromNib;
